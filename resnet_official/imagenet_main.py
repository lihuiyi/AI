...
from resnet_official import resnet_run_loop


data_dir = r"F:\data\花"
train_dir = os.path.join(data_dir, "trainSet")
eval_dir = os.path.join(data_dir, "validationSet")
...
# Data processing
###############################################################################
def get_filenames(is_training, train_dir, eval_dir):
    if is_training:
...
def input_fn(is_training, data_dir, batch_size, num_epochs=1,
  ...
  """
  filenames = get_filenames(is_training, train_dir, eval_dir)
